...
<body>
 <div id="admin_common_include_title">
  ...
  <p class="title_text">등록관리자</p>
  <p class="title_detail_text">등록관리자상세 정보 보는 페이지 입니다.</p>
 </div>
 <div id="admin_common_include_subject">
 <span class="subject_icon"></span>    
 <p class="subject_text">관리자정보 입력 관리</p>
 <p class="subject_detail_text">관리자정보 입력 기본정보</p>
 </div>
...
<div id="admin_common_include_subject">
 <span class="subject_icon"></span>    
 <p class="subject_text">관리자상세정보 입력 관리</p>
 <p class="subject_detail_text">관리자상세정보 입력 기본정보</p>
 </div>
 ...
 <table id="admin_common_wirte_table">
  ...
  <tr>
   ...
   <div id="admin_common_submit_wrap">
	<a class=bt_edit href="index.php?p=operate/admin_member_edit&admin_id=<?=$data["ADMIN_ID"] ?>"></a>
