...
<body>
 <div id="admin_common_include_title">
  ...
  <p class="title_text">게시글 등록</p>
  <p class="title_detail_text">게시글등록 하는 페이지 입니다.</p>
 </div>
...
<form name="form" method="post" action="index.php?p=board/board_write_ok"> 
 <table id="admin_common_wirte_table">
  <tr>
  <tr>
   <th>게시글유형</th>
   <td>
    <?php get_board_type($board_type) ?>
   </td>
  </tr>
   <th>제목</th>
   <td>
   <input type="text" class="input_size30" name="board_title"/>
   </td>
  </tr>
  <tr>
   <th>내용</th>
   <td>
    <textarea name="board_text" rows="20" cols="140"></textarea>
   </td>
  </tr>
  </table>
