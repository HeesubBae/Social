...
<body>
 ...
 <span class="title_icon"></span>
  <p class="title_text">업체회원정보</p>
  <p class="title_detail_text">등록된 업체회원정보 리스트페이지입니다.</p>
 </div>
 <div id="admin_common_include_subject">
 <span class="subject_icon"></span>
 <p class="subject_text">업체회원 기본정보리스트</p>
...
?>
		<tr onClick=reback_member_list('<?=$data["MEMBER_IDX"]?>','<?=$data["MEMBER_NAME"]?>')>
			<td><b><a href=index.php?p=member/company_member_view&admin_id=<?=$data["ADMIN_ID"]?>><?=$data["MEMBER_ID"]?></a></b></td>
