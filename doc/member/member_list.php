...
<body>
 ...
 <span class="title_icon"></span>
  <p class="title_text">회원정보</p>
  <p class="title_detail_text">등록된 회원정보 리스트페이지입니다.</p>
 </div>
 <div id="admin_common_include_subject">
 <span class="subject_icon"></span>
 <p class="subject_text">회원 기본정보리스트</p>
...
<?php
	...
	$sql = 'begin member_select_list(:i_txt, :i_nowpage, :i_pagesize, :v_out, :i_search_type); end;';
	...
	//$member_search_txt=$_GET['member_search_txt'];
...
?>
		<tr onClick=reback_member_list('<?=$data["MEMBER_IDX"]?>','<?=$data["MEMBER_NAME"]?>')>
			<td><b><a href=index.php?p=member/member_view&member_idx=<?=$data["MEMBER_IDX"]?>><?=$data["MEMBER_ID"]?></a></b></td>
