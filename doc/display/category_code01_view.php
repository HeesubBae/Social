...
<body>
 <div id="admin_common_include_title">
  ...
  <p class="title_text">등록1차카테고리</p>
  <p class="title_detail_text">등록1차카테고리상세 정보 보는 페이지 입니다.</p>
 </div>
 ...
 <table id="admin_common_wirte_table">
  ...
  <tr>
   ...
   <div id="admin_common_submit_wrap">
	<a class=bt_edit href="index.php?p=display/category_code01_edit&category_code01_id=<?=$data["CATEGORY_CODE01_ID"] ?>"></a>
