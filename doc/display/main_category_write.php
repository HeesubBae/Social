...
<body>
 <div id="admin_common_include_title">
  ...
  <p class="title_text">메인카테고리등록</p>
  <p class="title_detail_text">메인카테고리등록 하는 페이지 입니다.</p>
 </div>
...
<form name="form" method="post" action="index.php?p=display/main_category_write_ok"> 
 <table id="admin_common_wirte_table">
  <tr>
   <th>메인카테고리명</th>
   <td>
    <input type=text class="input_size30" name=main_category_name >
   </td>
  </tr>
  </table>
