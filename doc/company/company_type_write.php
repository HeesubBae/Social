...
<body>
 <div id="admin_common_include_title">
  ...
  <p class="title_text">회사유형등록</p>
  <p class="title_detail_text">회사유형등록 하는 페이지 입니다.</p>
 </div>
...
<form name="form" method="post" action="index.php?p=company/company_type_write_ok"> 
 <table id="admin_common_wirte_table">
  <tr>
   <th>직책명</th>
   <td>
    <input type="text" class="input_size30" name="company_type_name"/>
   </td>
  </tr>  
  <tr>
