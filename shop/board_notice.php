...
<div class="middle_bar"><img src="css/img_shop/middle_bar_02.jpg"></div>
<ul class="in_category_bar">
	<li><a href="board_notice.php"><img src="css/img_shop/customer_tab01_on.jpg"/></a><li>
	<li><a href="board_faq.php"><img src="css/img_shop/customer_tab02.jpg"/></a><li>
	<li><a href="customer_termsOfService.php"><img src="css/img_shop/customer_tab03.jpg"/></a><li>
	<li><a href="customer_privacy.php"><img src="css/img_shop/customer_tab04.jpg"/></a><li>
	<li><a href="customer_youthpolicy.php"><img src="css/img_shop/customer_tab05.jpg"/></a><li>
</ul>
<div class="indiv">
<!-- 상단이미지 || 현재위치 -->
<TABLE class="old_design_table" width=100% cellpadding=0 cellspacing=0 border=0>
<tr>
	<td><img src="css/img/common/title_notice.gif" border=0></td>
</tr>
<TR>
	<td class="path">HOME > 고객센터 > <B>공지사항</B></td>
</TR>
</TABLE>
...
<c:forEach var="i" items="${datas}">
	<tr height=27 onmouseover=this.style.backgroundColor="#FAFAFA" onmouseout=this.style.backgroundColor="">
		...
		<td width=50 nowrap align=center class=eng>
			...
			<td width=50>&nbsp;</td>
		<td width=100% style="padding-left:10px">${i.board_title}&nbsp;[${i.board_rep_count }]</td>
		<td width=100 nowrap align=center>${i.member_name}</td>

		<td width=100 nowrap align=center class=eng>${i.board_date}</td>
